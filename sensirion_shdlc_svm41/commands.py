...
class UpdateData(Transfer):
    ...
    def pack(self):
        return self.tx_data.pack([0x2, self._data])

    tx = TxData(CMD_ID, '>BB128B')


class StopUpdate(Transfer):
    """
    ...
    def pack(self):
        return self.tx_data.pack([0x3, self._checksum])

    tx = TxData(CMD_ID, '>BBB')
