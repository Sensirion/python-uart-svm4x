...
from sensirion_uart_svm4x.commands import (DeviceReset, EnterBootloader, GetNoxState, GetNoxTuningParameters,
                                           GetProductName, GetProductType, GetSerialNumber, GetSystemUpTime,
...
class Svm4xDeviceBase:
    ...
    def enter_bootloader(self):
        ...
        .. note::
            After the response frame is received, the device will not accept new commands
            until fully booted (wait at least 1 s).
        """
